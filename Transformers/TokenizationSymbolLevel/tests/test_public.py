...
class TestCase(unittest.TestCase):
    def test_tokenization1(self):
        words = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce vel ex vitae erat convallis! Maecenas?'.split()
    ...
    def test_tokenization3(self):
        words = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789!@$%^&*()-_=+[{]};:,<.>/?`'.split()
        self.assertEqual(tokenization(words), correct_tokenization(words), msg='Incorrect tokenization')
