...
def correct_hprebn_bp(n, dbndiff, dbnmeani):
    '''
    :param n: int
...
def correct_embcat_bp(dhprebn, W1):
    '''
...
def correct_W1_bp(embcat, dhprebn):
    '''
...
def correct_emb_bp(dembcat, emb):
    '''
